...
Questions: How do these trends differ in terms of the catch time series when these parameters are varied? What do the numbers in the smallest size class look like through time under these different parameters? How would these different values of erepro and Rmax influence the goodness of fit to data if we were to next use a time series fitting approach? What about the other species dynamics? 
...
#### Need to update north sea stock assessment data, here are the catches:
