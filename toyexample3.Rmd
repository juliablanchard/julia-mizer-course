...
mf.params <- newMultispeciesParams(species_params=groups,interaction=theta,kappa = 1e3,min_w_pp = 1e-16,w_pp_cutoff = 1,r_pp = 10,z0pre = 0.1)
...
####### feeding kernels - use box ones instead
params<-mf.params
