...
```{r}
params <- newTraitParams(max_w_inf = 1e+09,egg_size_scaling = T)
...
mf.params <- newMultispeciesParams(species_params=groups,interaction=theta,n=2/3,p=0.7,q=0.8,f=0.6,kappa = 1e3,min_w_pp = 1e-16,w_pp_cutoff = 10,r_pp = 10,z0pre = 0.1)

# mf.params@species_params$metab[1] <-0.01
mf.params@species_params$h[10] <- mf.params@species_params$h[10]*10
...
mf.params@species_params$R_max <- mf.params@species_params$R_max*10
...
mf.params<- setParams(mf.params,kappa=5e3)
