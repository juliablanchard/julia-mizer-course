...
mf.params<- setParams(mf.params,kappa=1e6)


sim <- project(mf.params, t_max=500)
plot(sim)
getFeedingLevel(sim)
...
Of we combine the biomassess from the model and add the data to  plot we cna look at how close/far we are.
