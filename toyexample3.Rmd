...
mf.params <- newMultispeciesParams(species_params=groups,interaction=theta,n=2/3,p=0.7,q=0.8,f=0.6,kappa = 1e8,min_w_pp = 1e-16,w_pp_cutoff = 100,r_pp = 2)

# mf.params@species_params$R_max[1] <-Inf
# mf.params@species_params$metab[1] <-0.01
# mf.params@species_params$h[] <- mean(mf.params@species_params$h)
# mf.params@species_params$gamma[1] <- 10*(mf.params@species_params$gamma[1])
# mf.params@species_params$alpha[1] <- 0.8
 #mf.params@species_params$z0[1] <- 0.0
 #mf.params@species_params$sigma[1] <-3
 #mf.params@species_params$beta[1] <-10
...
mf.params@interaction[1,1] <-0.5
sim <- project(mf.params, t_max=100)
plot(sim)
#plotlyGrowthCurves(sim,percentage = T,species="macrozooplankton")
...
plot(simbio$w_inf,simbio$simbio,xlab="log Maximum Weight [g]", ylab=" log Total Biomass", log="xy",col="grey",pch=16,ylim=c(1e-20,0.5))
...
kappa = 1e30
#params@species_params$R_max[1] <- Inf
params@species_params$repro_prop <- 0.8
params@species_params$erepro <- ifelse(params@species_params$erepro==1,0.001,params@species_params$erepro)
new.mf<-project(params,t_max=500,kappa=kappa)
params@interaction[]<- 0.1
