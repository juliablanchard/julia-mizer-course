...
We will move away from the default values and attempt to gain inference about the Rmax values from the catch data. First we will need to rewrite our functions to ensure we pass the optimizer the correct data and parameters.
